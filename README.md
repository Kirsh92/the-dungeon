...
**The Dungeon** is an open-source, text-based endless dungeon crawler with a dark LitRPG twist. As Subject #4.472, you must survive a brutal, randomized labyrinth while a cold, bureaucratic System and interplanar spectators judge your every move. Gather bizarre loot, uncover the dark truth left by past subjects, and try to break the cycle.

It is based on the source code of *Dungeon Crawler on Demand* by Redpangilinan, heavily modified to introduce deep lore, narrative events, and incremental survival mechanics.

The game is available for Android and Web/Desktop platforms. You can find official releases of the game on:

* [Google Play Store - Android Release] *(Próximamente)*
* [Web Version - Play in Browser] *(Próximamente)*

If you like this game and want to see more features, floors, and lore updates, please consider supporting me on GitHub Sponsors!
Issue reports of all kinds (bug reports, feature requests, etc.) are welcome.

## Contributing

Contributions are very welcome! Whether you want to add new bizarre items, expand the System's sarcastic dialogues, or improve the UI. Feel free to open issues and pull requests. Please read and follow our Code of Conduct.

## Community

* [Official Subreddit] *(Enlace pendiente)*
* [Discord Server] *(Enlace pendiente)*

## Credits

This game began as a fork to expand the narrative possibilities of the original engine, pivoting into a dark fantasy and LitRPG experience.
